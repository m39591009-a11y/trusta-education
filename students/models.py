...
class Student(models.Model):
    ...
    center = models.ForeignKey('users.Center', on_delete=models.CASCADE, null=True, blank=True, related_name='students')
    ...
    group = models.ForeignKey('groups.Group', on_delete=models.SET_NULL, null=True, blank=True, related_name='students', verbose_name='Гурӯҳ')
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='active', verbose_name='Статус')
    balance = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name='Баланс')
    start_date = models.DateField(auto_now_add=True, verbose_name='Таърихи қайд')
